...
class CharacterNetworkGenerator():
    ...
    def generate_character_network(self,df):
        ...
        for row in df['ners']:
            ...
            for sentence in row:
                previous_entites_in_window.append(list(sentence))
                previous_entites_in_window = previous_entites_in_window[-windows:]
                
                previous_entites_flattened = sum(previous_entites_in_window,[])
                
                for entity in sentence:
                    for entity_in_window in previous_entites_flattened:
